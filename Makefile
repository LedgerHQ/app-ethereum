...
APPNAME = "ThunderCore"
else ifeq ($(CHAIN),matic)
APP_LOAD_PARAMS += --path "44'/60'"
DEFINES += CHAINID_UPCASE=\"MATIC\" CHAINID_COINNAME=\"MATIC\" CHAIN_KIND=CHAIN_KIND_MATIC CHAIN_ID=137
APPNAME = "Matic"
else
...
listvariants:
	@echo VARIANTS CHAIN ethereum ropsten ethereum_classic expanse poa rsk rsk_testnet ubiq wanchain pirl akroma atheios callisto ethersocial ether1 gochain musicoin ethergem mix ellaism reosc hpb tomochain dexon volta ewc thundercore matic
