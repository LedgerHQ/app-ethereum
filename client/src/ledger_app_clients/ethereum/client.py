...
class EthAppClient:
    ...
    def _provide_trusted_name_common(self, payload: bytes, name_source: TrustedNameSource) -> RAPDU:
        ...
        if cert_apdu:
            self.pki_client.send_certificate(PKIPubKeyUsage.PUBKEY_USAGE_TRUSTED_NAME, bytes.fromhex(cert_apdu))
    ...
    def set_plugin(self,
        ...
        # pylint: enable=line-too-long
        if cert_apdu:
            self.pki_client.send_certificate(PKIPubKeyUsage.PUBKEY_USAGE_PLUGIN_METADATA, bytes.fromhex(cert_apdu))
    ...
    def provide_nft_metadata(self,
        ...
        # pylint: enable=line-too-long
        if cert_apdu:
            self.pki_client.send_certificate(PKIPubKeyUsage.PUBKEY_USAGE_NFT_METADATA, bytes.fromhex(cert_apdu))
    ...
    def provide_token_metadata(self,
        ...
        # pylint: enable=line-too-long
        if cert_apdu:
            self.pki_client.send_certificate(PKIPubKeyUsage.PUBKEY_USAGE_COIN_META, bytes.fromhex(cert_apdu))
    ...
    def provide_network_information(self,
        ...
        # pylint: enable=line-too-long
        if cert_apdu:
            self.pki_client.send_certificate(PKIPubKeyUsage.PUBKEY_USAGE_NETWORK, bytes.fromhex(cert_apdu))
    ...
    def provide_enum_value(self, payload: bytes) -> RAPDU:
        ...
        # pylint: enable=line-too-long
        self.pki_client.send_certificate(PKIPubKeyUsage.PUBKEY_USAGE_CALLDATA, bytes.fromhex(cert_apdu))
    ...
    def provide_tx_simulation(self, simu_params: TxSimu) -> RAPDU:
        ...
        # pylint: enable=line-too-long
        if cert_apdu:
            self.pki_client.send_certificate(PKIPubKeyUsage.PUBKEY_USAGE_TX_SIMU_SIGNER, bytes.fromhex(cert_apdu))
