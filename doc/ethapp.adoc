...
| TX_CHECKS_NORMALIZED_RISK     | 0x80        | 0x01              | Normalized risk score of the transaction.
| TX_CHECKS_NORMALIZED_CATEGORY | 0x81        | 0x01              | Main category explaining the risk score
| TX_CHECKS_PROVIDER_MSG        | 0x82        | variable (max 30) | Provider specific message explaining the risk score
| TX_CHECKS_TINY_URL            | 0x83        | variable (max 30) | URL to access the full report
| TX_CHECKS_SIMULATION_TYPE     | 0x84        | 0x01              | Type of simulation
| SIGNATURE                     | 0x15        | variable          | Signature of the TLV payload data
|======================================================================================================================
