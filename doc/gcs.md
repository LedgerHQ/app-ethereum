...
sequenceDiagram
    ...
    activate HW
    note left of HW: push into linked list of TX infos
    HW ->> SW: OK / KO

    SW ->> HW: NESTED - TX FIELD DESCRIPTION (AMOUNT)
    note left of HW: store only, don't parse / format
    HW ->> SW: OK / KO

    SW ->> HW: TX FIELD DESCRIPTION (CALLDATA)
    deactivate HW
    note left of HW: parse and format nested<br/>fields of last TX info
    HW ->> SW: OK / KO
