...
#define HASH_LENGTH 4
    array_hexstr(strings.txSummary.fullAddress, hashMessage, HASH_LENGTH / 2);
    strings.txSummary.fullAddress[HASH_LENGTH / 2 * 2] = '.';
    strings.txSummary.fullAddress[HASH_LENGTH / 2 * 2 + 1] = '.';
    strings.txSummary.fullAddress[HASH_LENGTH / 2 * 2 + 2] = '.';
    array_hexstr(strings.txSummary.fullAddress + HASH_LENGTH / 2 * 2 + 3, hashMessage + 32 - HASH_LENGTH / 2, HASH_LENGTH / 2);
