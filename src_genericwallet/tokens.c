...
const tokenDefinition_t const TOKENS[NUM_TOKENS] = {
    ...
    {{0x93, 0xE6, 0x82, 0x10, 0x7d, 0x1E, 0x9d, 0xef, 0xB0, 0xb5,
     ...
     "MCAP ",
     8},
    {{0xB0, 0x4c, 0xfa, 0x8a, 0x26, 0xD6, 0x02, 0xfb, 0x50, 0x23,
      0x2C, 0xEe, 0x0D, 0xaF, 0x29, 0x06, 0x02, 0x64, 0xe0, 0x4B},
     "MCO ",
     8},
    ...
    {{0x1d, 0xCE, 0x4F, 0xa0, 0x36, 0x39, 0xB7, 0xF0, 0xC3, 0x8e,
     ...
     "SRC ",
     8},
    {{0x55, 0xd3, 0x4b, 0x68, 0x6a, 0xa8, 0xC0, 0x49, 0x21, 0x39,
      0x7c, 0x58, 0x07, 0xDB, 0x9E, 0xCE, 0xdb, 0xa0, 0x0a, 0x4c},
     "SNT ",
     18},
