...
const contract_t CONTRACTS[NUM_CONTRACTS] = {
    ...
    {"Wrapped stETH", {0xae, 0x7a, 0xb9, 0x65, 0x20, 0xde, 0x3a, 0x18, 0xe5, 0xe1, 0x11, 0xb5, 0xea, 0xab, 0x09, 0x53, 0x12, 0xd7, 0xfe, 0x84}}};
...
bool check_contract(erc20_parameters_t *context) {
    for (size_t i = 0; i < NUM_CONTRACTS; i++) {
        ...
        PRINTF("%.*H || %.*H\n", 20, contract->address, 20, context->destinationAddress);
